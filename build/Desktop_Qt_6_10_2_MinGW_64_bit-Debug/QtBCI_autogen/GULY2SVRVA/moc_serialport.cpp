...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->portError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SerialPort::*)(const QByteArray & )>(_a, &SerialPort::dataReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialPort::*)(const QString & )>(_a, &SerialPort::portError, 1))
            return;
    }
}
...
// SIGNAL 1
void SerialPort::portError(const QString & _t1)
{
